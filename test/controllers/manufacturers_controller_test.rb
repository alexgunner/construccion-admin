...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { city: @manufacturer.city, country: @manufacturer.country, description: @manufacturer.description, email: @manufacturer.email, name: @manufacturer.name, phone: @manufacturer.phone } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { city: @manufacturer.city, country: @manufacturer.country, description: @manufacturer.description, email: @manufacturer.email, name: @manufacturer.name, phone: @manufacturer.phone } }
