...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { description: @about.description, name: @about.name } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { description: @about.description, name: @about.name } }
