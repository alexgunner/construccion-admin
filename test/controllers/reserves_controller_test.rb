...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post reserves_url, params: { reserf: { description: @reserf.description, name: @reserf.name } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { description: @reserf.description, name: @reserf.name } }
