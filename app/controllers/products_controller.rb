class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:reference_code, :name, :description, :price, :color, :code, :measure_id, :provider_id, :manufacturer_id, :category_id, :subcategory_id, :store_id, :picture, :offer)
    end
end
