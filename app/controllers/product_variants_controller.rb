class ProductVariantsController < ApplicationController
  ...
  private
    ...
    def product_variant_params
      params.require(:product_variant).permit(:size, :price, :wholesaleprice, :specialistprice, :importerprice, :product_id, :description, :code, :reposition, :reposition_date, :offerprice)
    end
end
